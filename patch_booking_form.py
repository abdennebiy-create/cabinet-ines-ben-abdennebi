...
old_form_start = r'''        <div class="form-group">
          <label for="bookingName" data-i18n="lbl_name">Nom Complet</label>'''

new_form_start = r'''        <div class="form-group">
          <label for="bookingAge" data-i18n="lbl_age">Profil du patient</label>
...
# Add the script logic inside the JS section
...
# Update handleFormSubmit to include these new fields
# I will just regex replace the string building part
